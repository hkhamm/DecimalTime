...
["", "decimaltime.dart", , M, {
  ...
  tick: [function() {
    ...
    document.querySelector("#time").textContent = C.JSInt_methods.toString$0(H.Primitives_getYear(now)) + "." + C.JSNumber_methods.toString$0(C.JSNumber_methods._tdivFast$1(now.difference$1(P.DateTime$_internal(H.Primitives_getYear(now), 1, 1, 0, 0, 0, 0, false))._duration, 86400000000) + 1) + "." + C.JSInt_methods.toString$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods._tdivFast$1(P.DateTime$_now().difference$1(P.DateTime$_internal(H.Primitives_getYear(now), H.Primitives_getMonth(now), H.Primitives_getDay(now), 0, 0, 0, 0, false))._duration, 1000000) / 86.4));
    P.Timer_Timer(C.Duration_100000, M.tick$closure());
  }, "call$0", "tick$closure", 0, 0, 0]
},
1],
]);
...
//# sourceMappingURL=decimaltime.dart.js.map
//@ sourceMappingURL=decimaltime.dart.js.map
